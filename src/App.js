    ...
    return (
      <div className="App">
        ...
        {this.state.isActive ? 
	        ...
	        <p>Content Based recommendations uses item features to recommend other songs similar to what the you as a user currently like, based on your previous actions or explicit feedback </p>
	        <p>You can click on the name of the song to hear a snippet of it, unfortunately not all songs may have snippets...</p>
	        ...
	        <p>Collaborative Filtering recommendations are based from a method of making automatic predictions (filtering) about the interests of a user by collecting preferences from many users, in this case your Spotify friends.</p>
	        <p>You can click on the name of the song to hear a snippet of it, unfortunately not all songs may have snippets...</p>
